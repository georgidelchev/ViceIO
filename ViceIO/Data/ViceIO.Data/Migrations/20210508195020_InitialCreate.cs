    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PictureCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiddleCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViceCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pictures_PictureCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "PictureCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Riddles_AspNetUsers_AddedByUserId",
                        column: x => x.AddedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Riddles_RiddleCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "RiddleCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vices_AspNetUsers_AddedByUserId",
                        column: x => x.AddedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vices_ViceCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "ViceCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PictureVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiddleVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RiddleVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ViceVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PictureVotes_UserId",
                table: "PictureVotes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RiddleCategories_IsDeleted",
                table: "RiddleCategories",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Riddles_AddedByUserId",
                table: "Riddles",
                column: "AddedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Riddles_CategoryId",
                table: "Riddles",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Riddles_IsDeleted",
                table: "Riddles",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_RiddleVotes_PictureId",
                table: "RiddleVotes",
                column: "PictureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViceCategories_IsDeleted",
                table: "ViceCategories",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Vices_AddedByUserId",
                table: "Vices",
                column: "AddedByUserId");
